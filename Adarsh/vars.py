...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '172.18.0.1'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '172.18.0.1:8080')) if not ON_HEROKU or getenv('FQDN', '172.18.0.1:8080') else APP_NAME+'.herokuapp.com'
